...
<body>
    ...
    <div class="text-center">
        ...
        <p>
            {{-- website_name -> Providers/AppServiceProvider global variabla --}}
            Thank you for purchasing with {{ $appSetting->website_name ?? 'Blex of Web IT' }}
            <br>
    ...
    <br>
    <p class="text-center">
        Thank your for shopping with Blex of Web IT
    </p>
