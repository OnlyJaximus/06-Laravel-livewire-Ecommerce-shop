...
@push('scripts')
    <script
        src="https://www.paypal.com/sdk/js?client-id=AeT0Ob-IVhk5VZPbTPbKpwsQvWW-6NdoKjYyWTFtjbrBWBhYXxK4QQHCWwF6NkNNYEVrJJqJr1gPXHDh&currency=USD">
    </script>
    <script>
        paypal.Buttons({
            ...
            onApprove: (data, actions) => {
                return actions.order.capture().then(function(orderData) {
                    ...
                    // COMPLETED -> satus we get from response
