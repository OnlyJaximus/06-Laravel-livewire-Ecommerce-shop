<div>
        ...
        <div class="container">
            <div class="row">
                ...
                <div class="col-md-3">
                    ...
                    {{-- <div class="mb-2"><a href="{{ url('/about-as') }}" class="text-white">About Us</a></div>
                    <div class="mb-2"><a href="{{ url('/contact-as') }}" class="text-white">Contact Us</a></div>
    ...
    <div class="copyright-area">
        <div class="container">
            <div class="row">
                <div class="col-md-8">
                    <p class=""> &copy; 2022 - Blex of Web IT - Ecommerce. All rights reserved.</p>
                </div>
                <div class="col-md-4">
