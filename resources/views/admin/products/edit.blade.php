                                    ...
                                    <div class="col-md-4">
                                        <div class="mb-3">
                                            ...
                                            <input type="checkbox" {{ $product->trending == '1' ? 'checked' : '' }}
                                                name="trending" style="width: 30px; height: 30px;">
                                        </div>
                                    </div>
                                    ...
                                    <div class="col-md-4">
                                        <div class="mb-3">
                                            ...
                                            <input type="checkbox" {{ $product->featured == '1' ? 'checked' : '' }}
                                                name="featured" style="width: 30px; height: 30px;">
                                        </div>
                                    </div>
                                            ...
                                            @foreach ($product->productImages as $image)
                                                <div class="col-md-2">
                                                    <img src="{{ asset($image->image) }}"
                                                        style="width: 80px; height: 80px;" class="me-4 border border-dark"
                                                        alt="Img" />
