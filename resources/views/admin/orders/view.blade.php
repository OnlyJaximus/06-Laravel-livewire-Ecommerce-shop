    ...
    <div class="row">
        <div class="col-md-12">
                ...
                <div class="shadow bg-white p-3">
                    ...
                    <h4 class="text-primary">
                        ...
                        <a href="{{ url('/admin/invoice/' . $order->id . '/generate') }}"
                            class="btn btn-primary btn-sm float-end mx-1"><span class="fa fa-download"></span> Download
                            Invoice</a>
                        ...
                        <a href="{{ url('/admin/invoice/' . $order->id . '/mail') }}"
                            class="btn btn-info btn-sm float-end mx-1"> <span class="fa fa-eye"></span> Send Invoice Via
                            Mail
                        </a>
                    </h4>
                    <hr>
                    <div class="row">
                        ...
                        <div class="col-md-6">
                            ...
                            <h6>Pin Code: {{ $order->payment_id }}</h6>
                        </div>
                    </div>
                    <br>
                    <h5>Order Items</h5>
            ...
            <div class="card border mt-3">
                <div class="card-body">
                    <h4>Order Process (Status Update)</h4>
                    <hr>
                    <div class="row">
                        <div class="col-md-5">
